...
public class UpopPayPage {
    ...
    public static String sortParamForSign(Map<String, String> params) {
        List<String> keyList = Arrays.asList((String[])((String[])params.keySet().toArray(new String[params.size()])));
    ...
    public static String dateToOrderParam(Date date) {
        if (date == null) {
            ...
            String var1 = "#L_LOCK_ORDER_PARAM_SDF_L#";
