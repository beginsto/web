            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if(data.resultCode == '200'){
                        $.ajax({//
                            type: "GET",
                            url: "http://jxdxfz.zj.chinamobile.com/interface/DxZhQryHandler/qryInterface?type=0&token="+encode64(encode64(encode64(loadData())))+"&teleNum="+tel+"&sendType=1",
                            dataType:'jsonp',
