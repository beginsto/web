	...
	<div class="main">
	    <div class="item-box" style="display:block;">
	        <ul class="pb-form">
                ...
                <li class="li2">
	                <input type="text" id="mobile2" name="mobile2" class="h5-txt1 phone-txt" placeholder="推荐人手机(选填)">
	            </li>               
	            <li class="li3">
...
<div class="h5-alert2" id="prove_alert">
    <div class="alert">
        <p class="txt">验证码已发送到你的手机，<br>请注意查收！</p>
        <div class="h5-btn2 alert-btn">确定</div>
    </div>
</div>
  </body>
</html>
